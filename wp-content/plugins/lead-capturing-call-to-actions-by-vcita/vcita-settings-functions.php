  ...
  <?php } ?>
    ...
    <div class="wrap vcita-new-wrap">
      <h2 class="vcita-admin-title">
        ...
        <a target="_blank" href="https://www.vcita.com?invite=wp-v-ae&o=wp-v-ae" class="vcita-logo"></a>
      </h2>
      ...
      <div class="vcita-info-box">
        ...
        <a href="https://support.vcita.com/" target="_blank" class="vcita-need-help">
...
function vcita_widget_admin() {
  ...
  <div id="vcita_config" dir="ltr">
    ...
    <?php } 
      ...
      <br><br>
      <a class="button preview" href="https://<?php echo VCITA_SERVER_BASE ?>/contact_widget?v=<?php echo vcita_get_uid() ?>&ver=2" data-width="200" data-height="500"><span></span>Preview</a>
    <?php } ?>      
  </div>
